  ...
  return (
    <footer >
      ...
      <div className="px-8 md:px-16 lg:px-36 flex justify-between py-4 border-t border-gray-300">
        <small className="text-xs text-gray-600">&copy; Copyrights Reserved</small>
        <small className="text-xs text-gray-600">2025 - {new Date().getFullYear()} &#124; African Heritage Guardians</small>
      </div>
      </div>
    </footer>
  );
