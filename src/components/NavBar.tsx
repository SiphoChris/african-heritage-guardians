...
//   return (
//     <nav className="flex justify-between items-center h-18 shadow px-8 md:px-16 lg:px-32 bg-white mb-16 relative">
//       <Link href="/" className="flex items-center">
//         <Image width={24} height={24} src="/globe.svg" alt="logo" />
//       </Link>
...
//                   className={clsx(
//                     "flex items-center gap-1 px-3 py-2 text-sm font-medium text-gray-700 rounded hover:bg-gray-100",
...
//                             href={subLink.href}
//                             className={clsx(
//                               "block px-4 py-3 text-sm text-gray-800 hover:bg-gray-100",
...
//                   href={link.href}
//                   className={clsx(
//                     "block px-3 py-2 text-sm font-medium text-gray-700 rounded hover:bg-gray-100",
...
//                     className="flex justify-between w-full px-4 py-3 text-base font-medium text-gray-700 rounded-md hover:bg-gray-100"
//                   >
//                     {link.name}
//                     <CaretDownIcon
//                       className={clsx(
...
//                             onClick={closeMobileMenu}
//                             className={clsx(
//                               "block px-4 py-2 text-sm text-gray-800 rounded hover:bg-gray-100",
//                               pathname === subLink.href &&
//                                 "bg-gray-100 font-semibold"
//                             )}
//                           >
...
//                     onClick={closeMobileMenu}
//                     className={clsx(
//                       "block px-4 py-3 text-base font-medium text-gray-700 rounded hover:bg-gray-100",
//                       link.name === "Support Us"
//                         ? "bg-amber-400 text-white hover:bg-amber-300"
//                         : "",
//                       pathname === link.href &&
      ...
      <ul className="hidden md:flex list-none gap-6 items-center">
        {navLinks.map((link) => {
          if (link.name === "Support Us") {
            return (
              <li key={link.name}>
                <Button size="2" className="hover:cursor-pointer bg-amber-400 text-white hover:bg-amber-300">
          ...
          return (
            <li key={link.name}>
              <Link
                ...
                className={clsx(
                  "block px-3 py-2 text-sm font-medium text-gray-700 rounded hover:bg-gray-100",
                  pathname === link.href && "bg-gray-300 text-blue-600"
                )}
              >
                {link.name}
              </Link>
            ...
            if (link.name === "Support Us") {
              return (
                <li key={link.name}>
                  <Button
                    size="3"
                    className="ml-4 hover:cursor-pointer bg-amber-400 text-white hover:bg-amber-300"
                  >
